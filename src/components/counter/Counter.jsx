...
function Counter({stock, onAdd}){
    ...
    <div><h3>Camisa</h3></div>
    
    <div className="mb-5"><p>Stock: {stock2}</p></div>
    ...
    <div className="buttons mb-2">
        ...
        <button type="button" className="btn btn-success" onClick={onAdd} disabled={!stock2}>Agregar Carrito</button>
    </div>
    <div>
    </div>
    </>
